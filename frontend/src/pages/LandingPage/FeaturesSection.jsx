        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="bg-white p-6 shadow-lg rounded-lg transform hover:scale-105 transition duration-300">
            ...
            <p className="text-gray-600">
              Grow your wealth with tailored investment plans that meet your
              financial goals.
            </p>
          </div>
          <div className="bg-white p-6 shadow-lg rounded-lg transform hover:scale-105 transition duration-300">
            ...
            <p className="text-gray-600">
              Save for your future with high-interest savings accounts that
          ...
          <div className="bg-white p-6 shadow-lg rounded-lg transform hover:scale-105 transition duration-300">
            ...
            <p className="text-gray-600">
              Join group savings schemes and benefit from collective investments
              for greater returns.
            </p>
          </div>
        </div>
