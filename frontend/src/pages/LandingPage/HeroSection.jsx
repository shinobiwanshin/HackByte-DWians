...
const HeroSection = () => {
  return (
    <section className="bg-purple-300 text-white w-full h-screen flex flex-col md:flex-row justify-between items-center pt-20 md:pt-0 px-8 md:px-16">
      {/* Left Side - Text */}
      <div className="flex flex-col justify-center items-start space-y-4 md:w-1/2">
        ...
        <div className="space-x-4 mt-4">
          <Link to="/register">
            <button className="bg-green-400 hover:bg-green-600 text-white px-6 py-3 rounded-lg text-lg transition duration-300">
              Get Started
            </button>
          </Link>
          <Link to="/signin">
